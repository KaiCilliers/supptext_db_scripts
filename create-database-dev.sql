...
-- -----------------------------------------------------
-- Table `sql_supptext`.`rooms`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sql_supptext`.`rooms` (
...
CREATE TABLE IF NOT EXISTS `sql_supptext`.`messages` (
  ...
  CONSTRAINT `fk_messages_rooms`
    FOREIGN KEY (`room_id`)
    REFERENCES `sql_supptext`.`rooms` (`room_id`)
    ON DELETE NO ACTION
    ON UPDATE CASCADE,
  CONSTRAINT `fk_messages_messages`
    FOREIGN KEY (`parent_id`)
    REFERENCES `sql_supptext`.`messages` (`message_id`)
    ON DELETE NO ACTION
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `sql_supptext`.`participants`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sql_supptext`.`participants` (
  `room_id` INT NOT NULL,
  `user_id` INT NOT NULL,
